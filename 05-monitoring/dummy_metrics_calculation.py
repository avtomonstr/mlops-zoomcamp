...
print(type(model))
print(model)  # Print the contents or attributes of the loaded object
...
def prep_db():
	with psycopg.connect("host=localhost port=5432 dbname=taxi_monitoring  user=postgres password=example", autocommit=True) as conn:
